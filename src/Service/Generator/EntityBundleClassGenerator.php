...
use Drupal\wmscaffold\EntityBundleClassMethodGeneratorInterface;
use Drupal\wmscaffold\EntityBundleClassMethodGeneratorManager;
...
class EntityBundleClassGenerator extends ClassGeneratorBase
{
    /** @var PluginManagerInterface */
    protected $pluginManager;
    /** @var EntityBundleClassMethodGeneratorManager */
    ...
    public function __construct(
        ...
        $this->baseClasses = $this->config->get('generators.bundle_class.base_classes') ?? [];
        $this->fieldsToIgnore = $this->config->get('generators.bundle_class.fields_to_ignore') ?? [];
    }
    ...
    protected function buildFieldGetter($field): ?array
    {
        ...
        /** @var EntityBundleClassMethodGeneratorInterface $generator */
